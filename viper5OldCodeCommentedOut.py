...
##                         + pas + '\nRemarks:' + rem
##            
##            buttons.append(Button(y,text=str(j+1) + ':See details',\
...
##                columnNo += 1
##
##            i.grid(row=counter + 1,column=columnNo)
##            counter += 1
...
##            print 'inside the main file, while creating GUI'
##            print thisrecord
...
##            counter += 1
    ...
    def callbackForModify(self,thisrecord):
        ...
        def callback():
            ...
            print 'inside callback,you selected this to modify:'
            print thisrecord
...
to the original record. no change will be made in the file')
            ...
            for i in filin:
                ...
                print
                print 'from file:',i
                print 'searching for:',remat
                print 'matching with:',rem
                print
